...
# (ma, ten, mo ta)
CHO = [
    ('ao_lang', 'Ao Làng', 'Ao nước tù giữa đồng, cá hiền, hợp người mới tập câu.'),
...
CA = [
    # --- Hồ ---
    ('ca_ro', 'Cá Rô', 1, 'ao_lang', 8, 22, 4, '#6b7a3a', '#9aad55',
     'Con cá quen mặt nhất ao hồ. Nhỏ mà lì.', 85),
    ('ca_diec', 'Cá Diếc', 1, 'ao_lang', 10, 26, 5, '#8a8f6a', '#b9bd8e',
     'Thịt lành, dân câu hay bắt được lúc sáng sớm.', 53),
    ('ca_chep', 'Cá Chép', 2, 'ao_lang', 20, 55, 7, '#9a6b2f', '#d19a4a',
     'Vảy vàng óng. Câu được con to là cả buổi vui.', 82),
    ('ca_tre', 'Cá Trê', 2, 'ao_lang', 18, 48, 8, '#3f3a33', '#6b6155',
     'Râu dài, trơn tuột, giãy khoẻ hơn vẻ ngoài.', 72),
    ('ca_qua', 'Cá Quả', 3, 'ao_lang', 30, 70, 11, '#3c4a3a', '#65785c',
