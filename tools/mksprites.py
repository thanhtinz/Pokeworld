...
MAP_SPRITE = {
    ...
    'red': 'adventurer',
    'leaf': 'heroine',
    # Huan luyen vien — dat ten theo VAI TRO trong the gioi Tuxemon, khong
    # muon ten hang huan luyen vien cua game khac nua.
    'nhoc': 'childactor',
    'be_gai': 'girl1',
    'bat_bo': 'disciple_green',
    'cam_trai': 'adventurer_green',
    'cam_trai_f': 'heroine_brown',
    'boi_f': 'swimmer_red',
    'boi_m': 'swimmer_blue',
    'da_ngoai': 'picnicker',
    'xero_m': 'cooldude_black',
    'xero_f': 'goth',
    'leo_nui': 'miner_blue',
    'scientist': 'scientist',
    'vo_su_dat': 'knight',
    'vo_su_nuoc': 'swimmer_green',
