...
LO_REN = (14, 21)               # bac tho ren ban da cuong hoa / da ngoi sao
...
def dung(root, tsx_cache, load_tsx, TILE=16):
    ...
    for _id, _ten, _gia, lx, ly in LO:
        ...
        don(lx + 1, ly + 4)
    for cho in (THO_MOC, TIEM_QUA, LO_REN):
        don(cho[0], cho[1])
    ...
    talks = [
        ...
        {'x': LO_REN[0], 'y': LO_REN[1] - 1, 'name': 'Biển Lò Rèn',
         'text': 'Lò rèn bác Thép — bán đá cường hoá, đá ngôi sao. '
                 'Trang bị thì không bán, tự đi mà kiếm.'},
    ]
...
def viet_js(lo, tho_moc, duong):
    ...
    out += [
        ...
        'export const LO_REN = { x: %d, y: %d };' % LO_REN,
