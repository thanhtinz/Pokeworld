...
export const ITEMS = {
  tuxeball: { name: 'Tuxeball', desc: 'Tuxeball cơ bản để bắt Tuxemon hoang.', kind: 'ball', price: 50, sell: 10, effect: { rate: 1 } },
  ...
  potion: { name: 'Thuốc Hồi', desc: 'Hồi 50 HP cho một Tuxemon.', kind: 'medicine', price: 20, sell: 5, effect: { heal: 50 } },
  ...
  revive: { name: 'Hồi Sinh', desc: 'Hồi sinh Tuxemon bất tỉnh với nửa HP.', kind: 'medicine', price: 100, sell: 20, effect: { revive: 0.5 } },
