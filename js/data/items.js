...
export const ITEMS = {
  // Thuốc hồi máu
  potion:        { name: 'Potion', desc: 'Hồi 20 HP cho một Pokémon.', icon: 'potion', sprite: 'potion',
                   kind: 'medicine', price: 300, sell: 150, effect: { heal: 20 } },
  super_potion:  { name: 'Super Potion', desc: 'Hồi 50 HP cho một Pokémon.', icon: 'super_potion', sprite: 'super_potion',
                   kind: 'medicine', price: 700, sell: 350, effect: { heal: 50 } },
  hyper_potion:  { name: 'Hyper Potion', desc: 'Hồi 120 HP cho một Pokémon.', icon: 'hyper_potion', sprite: 'hyper_potion',
                   kind: 'medicine', price: 1500, sell: 750, effect: { heal: 120 } },
  max_potion:    { name: 'Max Potion', desc: 'Hồi đầy HP cho một Pokémon.', icon: 'max_potion', sprite: 'max_potion',
                   kind: 'medicine', price: 2500, sell: 1250, effect: { heal: 'full' } },
  revive:        { name: 'Revive', desc: 'Hồi sinh Pokémon bất tỉnh với 50% HP.', icon: 'revive', sprite: 'revive',
  ...
  awakening:     { name: 'Awakening', desc: 'Đánh thức Pokémon đang ngủ.', icon: 'awakening', sprite: 'awakening',
  ...
  // Bóng bắt Pokémon
  poke_ball:     { name: 'Poké Ball', desc: 'Bóng bắt Pokémon cơ bản.', icon: 'poke_ball', sprite: 'poke_ball',
                   kind: 'ball', price: 200, sell: 100, ballMult: 1.0 },
  great_ball:    { name: 'Great Ball', desc: 'Bóng tốt, tỉ lệ bắt cao hơn Poké Ball.', icon: 'great_ball', sprite: 'great_ball',
  ...
  // Đá tiến hoá
  thunder_stone: { name: 'Thunder Stone', desc: 'Đá tiến hoá cho Pokémon hệ Điện.', icon: 'thunder_stone', sprite: 'thunder_stone',
                   kind: 'stone', price: 3000, sell: 1500 },
  water_stone:   { name: 'Water Stone', desc: 'Đá tiến hoá cho Pokémon hệ Nước.', icon: 'water_stone', sprite: 'water_stone',
                   kind: 'stone', price: 3000, sell: 1500 },
  fire_stone:    { name: 'Fire Stone', desc: 'Đá tiến hoá cho Pokémon hệ Lửa.', icon: 'fire_stone', sprite: 'fire_stone',
                   kind: 'stone', price: 3000, sell: 1500 },
  leaf_stone:    { name: 'Leaf Stone', desc: 'Đá tiến hoá cho Pokémon hệ Cỏ.', icon: 'leaf_stone', sprite: 'leaf_stone',
                   kind: 'stone', price: 3000, sell: 1500 },

  // Khác
  rare_candy:    { name: 'Rare Candy', desc: 'Tăng ngay 1 cấp cho Pokémon.', icon: 'rare_candy', sprite: 'rare_candy',
