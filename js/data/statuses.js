...
export const STATUSES = {
  ...
  "burn": { name: "Bỏng", cat: "negative", kind: "burnt", p: ["8", "weakest"], mods: {}, immune: ["fire"], keep: true, tmod: {"fire": 0.0, "frost": 2.0}, step: ["flat_damage", 1.0, 10] },
  ...
  "grabbed": { name: "Bị ghì", cat: "negative", kind: "grabbed", p: ["2", "ranged:reach"], mods: {}, immune: [], link: true },
  ...
  "lifegift": { name: "Ban sinh lực", cat: "negative", kind: "lifegift", p: ["16"], mods: {}, immune: [], link: true },
  "lifeleech": { name: "Hút máu", cat: "negative", kind: "lifeleech", p: ["16"], mods: {}, immune: [], link: true },
  "lockdown": { name: "Bị khoá", cat: "negative", kind: "lockdown", p: [], mods: {}, immune: [] },
  "noddingoff": { name: "Ngủ gật", cat: "negative", kind: "noddingoff", p: ["0.5"], mods: {}, immune: [], dur: 5 },
  "poison": { name: "Trúng độc", cat: "negative", kind: "poisoned", p: ["8", "weakest"], mods: {}, immune: ["venom"], keep: true, tmod: {"venom": 0.0}, step: ["flat_damage", 1.0, 10] },
