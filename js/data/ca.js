...
export const CHO_CAU = [
  { id: "ao_lang", name: "Ao Làng", desc: "Ao nước tù giữa đồng, cá hiền, hợp người mới tập câu." },
...
export const CA = [
  { id: "ca_ro", name: "Cá Rô", hiem: 1, cho: "ao_lang", dai: [8, 22], giaCm: 4, mau: "#6b7a3a", desc: "Con cá quen mặt nhất ao hồ. Nhỏ mà lì." },
  { id: "ca_diec", name: "Cá Diếc", hiem: 1, cho: "ao_lang", dai: [10, 26], giaCm: 5, mau: "#8a8f6a", desc: "Thịt lành, dân câu hay bắt được lúc sáng sớm." },
  { id: "ca_chep", name: "Cá Chép", hiem: 2, cho: "ao_lang", dai: [20, 55], giaCm: 7, mau: "#9a6b2f", desc: "Vảy vàng óng. Câu được con to là cả buổi vui." },
  { id: "ca_tre", name: "Cá Trê", hiem: 2, cho: "ao_lang", dai: [18, 48], giaCm: 8, mau: "#3f3a33", desc: "Râu dài, trơn tuột, giãy khoẻ hơn vẻ ngoài." },
  { id: "ca_qua", name: "Cá Quả", hiem: 3, cho: "ao_lang", dai: [30, 70], giaCm: 11, mau: "#3c4a3a", desc: "Săn mồi cỡ bự của hồ. Cắn câu là cần cong hẳn." },
