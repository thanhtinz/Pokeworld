...
export const TRAINERS = {
  ...
  champion_blue: {
    sprite: 'rival', name: 'Blue — Nhà Vô Địch', kind: 'rival', zone: 'league_1', story: true,
  ...
  sailor_route3: {
    sprite: 'swimmer_f', name: 'Swimmer Mai', kind: 'trainer', zone: 'route_3',
  ...
  camper_route3: {
    sprite: 'camper', name: 'Camper Hùng', kind: 'trainer', zone: 'route_3',
  ...
  cool_thunder: {
    sprite: 'cooltrainer_m', name: 'Cooltrainer Bảo', kind: 'trainer', zone: 'city_thunder',
  ...
  lass_rainbow: {
    sprite: 'lass', name: 'Lass Hương', kind: 'trainer', zone: 'city_rainbow',
  ...
  channeler_tower: {
    sprite: 'channeler', name: 'Channeler Ly', kind: 'trainer', zone: 'tower_radio',
  ...
  swimmer_light: {
    sprite: 'swimmer_f', name: 'Swimmer Thảo', kind: 'trainer', zone: 'lighthouse_1',
  ...
  cool_cinnabar: {
    sprite: 'cooltrainer_m', name: 'Cooltrainer Khoa', kind: 'trainer', zone: 'island_cinnabar',
  ...
  camper_victory: {
    sprite: 'camper', name: 'Hiker Sơn', kind: 'trainer', zone: 'mountain_1',
  ...
  cool_victory: {
    sprite: 'cooltrainer_m', name: 'Cooltrainer Quân', kind: 'trainer', zone: 'mountain_1',
  ...
  channeler_unknown: {
    sprite: 'channeler', name: 'Nhà nghiên cứu Mio', kind: 'trainer', zone: 'cave_unknown',
