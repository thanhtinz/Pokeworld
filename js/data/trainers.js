...
export const TRAINERS = {
  // Trainer thường
  youngster_minh: {
    sprite: 'youngster', name: 'Nhóc Minh', kind: 'trainer', zone: 'route_1',
  ...
  lass_lan: {
    sprite: 'lass', name: 'Cô Bé Lan', kind: 'trainer', zone: 'route_1',
  ...
  hiker_dung: {
    sprite: 'camper', name: 'Bác Dũng Leo Núi', kind: 'trainer', zone: 'cave_1',
  ...
  gym_thuy: {
    sprite: 'misty', name: 'Thủy', kind: 'gym', zone: 'lake_1',
  ...
  rival_1: {
    sprite: 'rival', name: 'Khôi', kind: 'rival', zone: 'route_1', story: true,
  ...
  rival_2: {
    sprite: 'rival', name: 'Khôi', kind: 'rival', zone: 'route_2', story: true,
  ...
  rocket_1: {
    sprite: 'rocket_m', name: 'Hỏa Tiễn Cấp Dưới', kind: 'rocket', zone: 'forest_1', story: true,
  ...
  rocket_2: {
    sprite: 'rocket_f', name: 'Bộ Đôi Hỏa Tiễn', kind: 'rocket', zone: 'cave_1', story: true,
  ...
  rocket_boss: {
    sprite: 'giovanni', name: 'Trùm Hỏa Tiễn', kind: 'rocket', zone: 'lake_1', story: true,
